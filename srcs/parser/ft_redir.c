...
/*   Updated: 2021/12/27 10:48:53 by asgaulti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// dans ce cas : deplacer les maillons avec des pipes au debut dans la liste cmd?
t_redir *ft_fillout(t_cmd *cmd, t_redir *redir)
{
    while (cmd && cmd->next != NULL)
    {
    printf("cmd %s std %d next = %p\n", cmd->cmd, cmd->std, cmd->next);
